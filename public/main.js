...
function createWindow() {
  ...
  // in production, set the initial browser path to the local bundle generated by the Create React App build process.
...
// if the app has no need to navigate or only needs to navigate to known pages,
// it is a good idea to limit navigation outright to that known scope, disallowing any other kinds of navigation.
